...
/**
 * find_variable - Find a variable in the list.
 * @name: The name of the variable to find.
 * @head: The head of the list.
 * Return: A pointer to the variable if found, otherwise NULL.
 */
list_path *find_variable(char *name, list_path *head)
{
	while (head)
	{
...
/**
 * _varcmp - Compare a variable name with a full variable string.
...
/**
 * num_to_char - Convert an integer to a string.
...
/**
 * char_count_piped - Count the number of occurrences of a character in a string.
