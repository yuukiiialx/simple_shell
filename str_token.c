...
/**
 * free_l_v - Free memory associated with a line and its token vector.
 * @line: The line to be freed.
 * @line_vector: The token vector to be freed.
 */
 ...
 * @line: The path to check.
 * @argv: Command-line argument values.
 * @counter: The command counter.
 * @line_vector: Tokenized command line.
 * @status: The exit status.
 * @old_line: The previous line.
 * Return: 0 if it's a directory, -1 if it's not.
 */
